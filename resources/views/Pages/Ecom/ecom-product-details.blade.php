                                                                    ...
                                                                    <div class="border border-dashed rounded p-3">
                                                                        ...
                                                                        <div class="d-flex flex-grow-1 gap-2 mb-3">
                                                                            <a href="#" class="d-block">
                                                                                <img src="{{asset('assets')}}/images/small/img-12.jpg" alt="" class="avatar-sm rounded object-fit-cover">
                                                                            </a>
                                                                            <a href="#" class="d-block">
                                                                                <img src="{{asset('assets')}}/images/small/img-11.jpg" alt="" class="avatar-sm rounded object-fit-cover">
                                                                            </a>
                                                                            <a href="#" class="d-block">
                                                                                <img src="{{asset('assets')}}/images/small/img-10.jpg" alt="" class="avatar-sm rounded object-fit-cover">
                                                                            </a>
                                                                        </div>
